...
##### Option 1: Run the jar file
  1. Download the jar file named "TaskerCLI_3.22.jar"
  2. Open your terminal and type ```java -jar /path/to/TaskerCLI_3.22.jar <command> <subcommand>```
  3. To make it more convenient, add the alias to your !/.bash_aliases: ```alias tasker="java -jar /path/to/TaskerCLI_3.22.jar"```
